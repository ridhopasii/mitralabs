    ...
    solution: {
      ...
      cards: {
        ...
        business: {
          ...
          image: "/mitralabs_business_service.png"
        }
      }
    },
    process: {
...
async function main() {
  ...
  // 1. Clean & Seed SiteConfig
  console.log("Cleaning & Seeding SiteConfig...");
  ...
  await prisma.siteConfig.create({
    data: {
      ...
      footer_desc: "Mitra Digital Bisnis Mu. Mitralabs.id — Medan, Indonesia.",
      wa_number: "6282381118520",
      business_mode: "agresif",
      wa_promo_msg: "🔥 Promo Bulan Ini! Hubungi kami sekarang untuk penawaran spesial.",
      phone: "6282381118520",
      email: "ridhorobbipasi@gmail.com",
      instagram: "@mitralabs.id",
      address: "Medan, Sumatera Utara",
      maps_url: "https://maps.app.goo.gl/tkf2KxR8h9ZsskkL7",
      company_npwp: "00.000.000.0-000.000",
      company_tagline: "Mitra Digital Bisnis Mu",
      company_website: "www.mitralabs.web.id",
      linkedin_url: "linkedin.com/company/mitralabs-id",
      logo_url: "/logo.png",
      favicon_url: "/favicon.ico",
      json_content: initialData
    }
  });

  // 2. Clean & Seed HeroSection
  console.log("Cleaning & Seeding HeroSection...");
  ...
  await prisma.heroSection.create({
    data: {
      ...
      title: "Website Profesional untuk Bisnis Kamu. Selesai 7 Hari. Harga Jelas. Tanpa Ribet.",
      subtitle: "Mitralabs.id hadir buat kamu yang capek bisnis bagus tapi tidak ada yang tahu. Kami buatkan website yang beneran kerja — bukan cuma bagus di mata, tapi menghasilkan di kantong.",
      image_url: "/mitralabs_hero_premium_1778227502346.png",
      stats_label: "Project Selesai",
      stats_value: "Puluhan",
      stats_desc: "UMKM, Sekolah, dan Bisnis Lokal di Medan sudah dipercayakan ke kami"
    }
  });

  // 3. Clean & Seed TeamMember
  console.log("Cleaning & Seeding TeamMember...");
    ...
    data: [
      {
        ...
        bio: "Mahasiswa yang sudah jatuh cinta dengan dunia web development sejak SMA. Ridho yang bangun setiap baris kode di website klien Mitralabs — dari desain sampai deployment. \"Aku percaya website yang bagus bukan soal tampilan saja. Harus cepat, aman, dan beneran berguna untuk bisnis klien.\"",
        image_url: "/ridho.jpg",
        order: 1
      },
      {
        ...
        name: "Ghazy Muhalla",
        role: "Marketing",
        bio: "Ghazy yang jaga komunikasi dengan klien dan mastiin setiap project berjalan sesuai ekspektasi. Dia yang jadi jembatan antara kebutuhan bisnis klien dan kemampuan teknis tim. \"Klien yang puas bukan yang websitenya bagus doang — tapi yang ngerasa didengar dan dibantu dari awal sampai akhir.\"",
        image_url: "/ghazy.jpg",
        order: 2
      }
    ]
  ...
  // 4. Clean & Seed FAQ
  console.log("Cleaning & Seeding FAQ...");
  ...
  // 5. Clean & Seed Testimonial
  console.log("Cleaning & Seeding Testimonial...");
  ...
  await prisma.testimonial.create({
    data: {
      ...
      content: "Sementara kami kumpulkan testimoni nyata dari klien kami... Kamu bisa jadi yang pertama merasakannya.",
      rating: 5,
      image_url: "https://ui-avatars.com/api/?name=K&background=random",
      is_published: true
    }
  });

  // 6. Clean & Seed ServicePlan
  console.log("Cleaning & Seeding ServicePlan...");
  ...
  console.log("Database successfully seeded & synchronized!");
}
