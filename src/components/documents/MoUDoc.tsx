      ...
      <div className="w-full max-w-[800px] bg-white rounded-[40px] shadow-sm border border-slate-100 overflow-hidden italic">
        ...
        <div className="p-10 md:p-16 space-y-10 italic">
          <div className="text-center space-y-3">
             <h2 className="text-3xl font-black tracking-tighter uppercase italic border-b-4 border-slate-900 inline-block pb-1 leading-none italic">MEMORANDUM OF UNDERSTANDING (MoU)</h2>
             <p className="text-blue-600 text-[11px] font-bold uppercase tracking-widest italic leading-none">Kesepakatan Awal Kerja Sama Pembuatan Website</p>
          </div>
          ...
          <div className="p-8 bg-slate-50 rounded-3xl border border-slate-100 italic space-y-4">
             <div className="grid grid-cols-2 gap-x-12 gap-y-6">
                <div>
                  <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1 italic">Tanggal</p>
                  <p className="text-sm font-black text-slate-900 italic">{new Date().toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' })}</p>
                </div>
                <div>
                  <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1 italic">Pihak Pertama</p>
                  <p className="text-sm font-black text-slate-900 italic">Mitralabs.id — {data?.invoiceSettings?.signatureFields?.ownerName}</p>
                </div>
                <div>
                  <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1 italic">Pihak Kedua (Klien)</p>
                  <p className="text-sm font-black text-slate-900 italic">{booking?.customer_name || '________________________________'}</p>
                </div>
                <div>
                  <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1 italic">Nama Usaha</p>
                  <p className="text-sm font-black text-slate-900 italic">{booking?.organization_name || '________________________________'}</p>
                </div>
             </div>
          </div>
          ...
          <div className="space-y-10 italic">
            <div className="space-y-3 italic">
              <h4 className="text-xs font-black uppercase tracking-[0.2em] text-slate-900 italic flex items-center gap-2"><div className="w-1.5 h-1.5 bg-blue-600 rounded-full"/> Pasal 1 — Ruang Lingkup</h4>
              <div className="text-sm text-slate-600 pl-4 space-y-1 italic leading-relaxed">
            ...
            <div className="space-y-3 italic">
              <h4 className="text-xs font-black uppercase tracking-[0.2em] text-slate-900 italic flex items-center gap-2"><div className="w-1.5 h-1.5 bg-blue-600 rounded-full"/> Pasal 2 — Paket & Harga Awal</h4>
              <div className="text-sm text-slate-600 pl-4 space-y-1 italic leading-relaxed">
            ...
            <div className="space-y-3 italic">
              <h4 className="text-xs font-black uppercase tracking-[0.2em] text-slate-900 italic flex items-center gap-2"><div className="w-1.5 h-1.5 bg-blue-600 rounded-full"/> Pasal 3 — Panjar / DP</h4>
              <div className="text-sm text-slate-600 pl-4 space-y-1 italic leading-relaxed">
            ...
            <div className="space-y-3 italic">
              <h4 className="text-xs font-black uppercase tracking-[0.2em] text-slate-900 italic flex items-center gap-2"><div className="w-1.5 h-1.5 bg-blue-600 rounded-full"/> Pasal 4 — Timeline</h4>
              <div className="text-sm text-slate-600 pl-4 space-y-1 italic leading-relaxed">
            ...
            <div className="space-y-3 italic">
              <h4 className="text-xs font-black uppercase tracking-[0.2em] text-slate-900 italic flex items-center gap-2"><div className="w-1.5 h-1.5 bg-blue-600 rounded-full"/> Pasal 5 — Komitmen Bersama</h4>
              <div className="text-sm text-slate-600 pl-4 space-y-1 italic leading-relaxed">
          ...
          <p className="text-sm font-black text-slate-900 text-center italic mt-12 underline decoration-blue-100 decoration-4">
          ...
          <div className="pt-10 space-y-12 italic">
            ...
            <div className="grid grid-cols-2 gap-16 italic">
              <div className="text-center space-y-20 italic">
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest italic leading-none">Pihak Pertama,</p>
                <div className="space-y-1 italic">
                  ...
                  <p className="text-sm font-black text-slate-900 italic leading-none underline decoration-slate-200">{data?.invoiceSettings?.signatureFields?.ownerName}</p>
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest italic leading-none">{data?.invoiceSettings?.signatureFields?.ownerTitle}</p>
                </div>
              </div>
              <div className="text-center space-y-20 italic">
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest italic leading-none">Pihak Kedua,</p>
                <div className="space-y-1 italic">
                  <div className="relative h-20 flex items-center justify-center">
        ...
        <div className="bg-[#1D1D1F] px-16 py-8 flex justify-between items-center italic">
          ...
          <p className="text-[9px] text-slate-500 font-bold uppercase tracking-widest italic leading-none tracking-[0.2em]">Official Memorandum Agreement • 2026</p>
        </div>
      </div>
    </div>
  );
